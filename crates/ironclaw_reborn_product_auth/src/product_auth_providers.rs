...
use crate::config::{OAuthDcrProviderBackendConfig, OAuthProviderBackendConfig};
use crate::error::OAuthProviderCompositionError;
...
#[derive(Clone)]
pub struct OAuthProviderComposition {
    pub client: Option<Arc<dyn AuthProviderClient>>,
    pub dcr_registry: Option<Arc<OAuthDcrProviderRegistry>>,
    pub gate_registry: Option<Arc<GoogleOAuthGateProviderRegistry>>,
}

pub fn compose_provider_client(
...
) -> Result<OAuthProviderComposition, OAuthProviderCompositionError> {
...
fn compose_provider_client_with_runtime(
    ...
    for config in configs {
        ...
        .map_err(|error| OAuthProviderCompositionError::InvalidConfig {
            reason: format!(
