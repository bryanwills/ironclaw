...
#[derive(Clone)]
pub struct GoogleOAuthGateProviderRegistry {
    providers: BTreeMap<String, Arc<GoogleOAuthGateProvider>>,
}

impl GoogleOAuthGateProviderRegistry {
    pub fn new(providers: Vec<Arc<GoogleOAuthGateProvider>>) -> Self {
        Self {
            providers: providers
                .into_iter()
...
#[derive(Clone)]
pub struct GoogleOAuthGateProvider {
...
impl GoogleOAuthGateProvider {
    pub fn new(client: OAuthClientConfig, secret_store: Arc<dyn SecretStore>) -> Self {
        Self {
            client,
            secret_store,
