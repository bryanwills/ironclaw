...
const MAX_MEMORY_CONTEXT_REF_BYTES: usize = 256;
...
fn admit_memory_context_snippet(
    ...
    if snippet.snippet_ref.len() > MAX_MEMORY_CONTEXT_REF_BYTES
        || !snippet.snippet_ref.starts_with(MEMORY_CONTEXT_REF_PREFIX)
