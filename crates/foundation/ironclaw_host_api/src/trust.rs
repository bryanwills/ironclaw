...
//!   eventual built-in tools (see `crates/policy/ironclaw_trust/CONTRACT.md` §9 for
//!   the migration path).
...
//! effective trust, `crates/policy/ironclaw_trust/CONTRACT.md` for the full
...
/// | Built-in tools (eventual) | `Bundled` | See `crates/policy/ironclaw_trust/CONTRACT.md` §9 for migration |
///
