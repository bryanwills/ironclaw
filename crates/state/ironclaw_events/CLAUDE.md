...
`crates/state/ironclaw_reborn_event_store/`. Keep storage drivers out of this
...
`crates/meta/ironclaw_architecture/tests/reborn_dependency_boundaries.rs`; if the
