...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_COMPLETE_NEARAI_WALLET_LOGIN, WEBUI_V2_ROUTE_CONNECTORS_CONNECTED,
    WEBUI_V2_ROUTE_CONNECTORS_READ, WEBUI_V2_ROUTE_CONNECTORS_WRITE, WEBUI_V2_ROUTE_CREATE_PROJECT,
    ...
    WEBUI_V2_ROUTE_INSTALL_EXTENSION, WEBUI_V2_ROUTE_INSTALL_SKILL, WEBUI_V2_ROUTE_LIST_APPROVALS,
