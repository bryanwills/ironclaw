...
fn expected_table() -> Vec<Expected> {
    vec![
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_LIST_APPROVALS,
            method: NetworkMethod::Get,
            pattern: "/api/webchat/v2/approvals",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: BodyLimitPolicy::NoBody,
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_CONNECTORS_CONNECTED,
            method: NetworkMethod::Get,
            pattern: "/api/webchat/v2/connectors/connected",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: BodyLimitPolicy::NoBody,
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_CONNECTORS_READ,
            method: NetworkMethod::Post,
            pattern: "/api/webchat/v2/connectors/read",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: body_limit_kib(16),
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_CONNECTORS_WRITE,
            method: NetworkMethod::Post,
            pattern: "/api/webchat/v2/connectors/write",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
