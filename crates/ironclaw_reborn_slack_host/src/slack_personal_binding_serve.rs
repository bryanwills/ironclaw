...
#[derive(Clone)]
pub struct SlackPersonalBindingRouteState {
    binding_service: SlackPersonalUserBindingService,
    oauth_client: Arc<dyn SlackPersonalBindingOAuthClient>,
    callback_url: String,
...
impl SlackPersonalBindingRouteState {
    pub fn new(config: SlackPersonalBindingRouteConfig) -> Self {
        Self {
...
/// Bearer-protected OAuth start half plus public callback half of the
/// Slack personal-binding WebUI surface. Hosts attach the halves via
/// [`crate::WebuiServeConfig::with_protected_route_mount`] /
/// [`crate::WebuiServeConfig::with_public_route_mount`]; the full
/// descriptor set rides the protected half (both halves share the
/// composed descriptor-driven middleware state).
pub struct SlackPersonalBindingRouteMount {
    pub protected: ProtectedRouteMount,
    pub public: PublicRouteMount,
}

/// Build the Slack personal-binding WebUI OAuth route mounts.
pub fn slack_personal_binding_route_mount(
    ...
    SlackPersonalBindingRouteMount {
        protected: ProtectedRouteMount::new(
            ...
            slack_personal_binding_route_descriptors(),
        ),
...
mod tests {
    ...
    async fn callback_with_state(
        ...
        let app = Router::new().merge(slack_personal_binding_route_mount(state).public.router);
        app.oneshot(
            Request::builder()
                .method("GET")
                .uri(format!(
