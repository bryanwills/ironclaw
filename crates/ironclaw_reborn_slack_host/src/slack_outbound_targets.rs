...
pub const SLACK_OUTBOUND_TARGET_LIST_PAGE_SIZE: usize = 500;
const SLACK_OUTBOUND_TARGET_LIST_MAX_TOTAL_ROUTES: usize = 10_000;

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SlackConfiguredChannelRoute {
    pub channel_id: String,
    pub subject_user_id: UserId,
}

impl SlackConfiguredChannelRoute {
    pub fn new(channel_id: String, subject_user_id: UserId) -> Self {
        Self {
            channel_id,
            subject_user_id,
        }
...
#[derive(Debug, Clone)]
pub struct SlackOutboundTargetProviderConfig {
    pub tenant_id: TenantId,
    pub agent_id: AgentId,
    pub project_id: Option<ProjectId>,
    pub installation_id: AdapterInstallationId,
    pub team_id: SlackTeamId,
    pub configured_channel_routes: Vec<SlackConfiguredChannelRoute>,
}

#[derive(Debug, Clone, PartialEq, Eq, Hash)]
pub struct SlackPersonalDmTargetKey {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SlackPersonalDmTarget {
...
pub enum SlackPersonalDmTargetError {
...
pub trait SlackPersonalDmTargetStore: Send + Sync + std::fmt::Debug {
...
pub struct InMemorySlackPersonalDmTargetStore {
...
pub struct SlackPersonalDmTargetProvisioner {
    tenant_id: TenantId,
    installation_id: AdapterInstallationId,
    team_id: SlackTeamId,
...
#[derive(Debug)]
pub struct SlackHostBetaOutboundTargetProvider {
    tenant_id: TenantId,
    agent_id: AgentId,
...
impl SlackHostBetaOutboundTargetProvider {
    ...
    pub fn channel_id_for_target_id<'a>(
        &self,
    ...
    pub fn channel_id_for_reply_target_binding_ref(
        &self,
        target: &ReplyTargetBindingRef,
    ) -> Option<String> {
