...
pub struct SlackChannelRouteListPage {
    pub routes: Vec<SlackChannelRoute>,
    pub next_cursor: Option<usize>,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SlackChannelRouteAssignment {
    pub(crate) channel_id: String,
...
/// Build the operator-gated WebUI mount for the Slack channel-route
/// admin surface. Composed only when the WebUI authenticator mounts
/// operator WebUI config routes, exactly like the native v2 operator
/// routes.
