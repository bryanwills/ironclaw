...
pub use active_publication::ActiveExtensionPublisher;
#[cfg(test)]
...
pub struct RebornLocalExtensionManagementPort {
...
impl RebornLocalExtensionManagementPort {
    ...
    pub async fn list_installed(&self) -> Result<LifecycleProductResponse, ProductWorkflowError> {
