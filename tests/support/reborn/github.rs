...
pub fn capability_ids() -> GithubSupportResult<Vec<CapabilityId>> {
    Ok(vec![
        ...
        CapabilityId::new("github.update_issue")?,
        CapabilityId::new("github.add_issue_labels")?,
        CapabilityId::new("github.remove_issue_label")?,
        CapabilityId::new("github.add_issue_assignees")?,
        CapabilityId::new("github.remove_issue_assignees")?,
        ...
        CapabilityId::new("github.update_pull_request")?,
        ...
        CapabilityId::new("github.list_pull_request_review_threads")?,
        CapabilityId::new("github.resolve_review_thread")?,
        CapabilityId::new("github.unresolve_review_thread")?,
        ...
        CapabilityId::new("github.get_workflow_run_jobs")?,
        CapabilityId::new("github.get_workflow_run_artifacts")?,
        CapabilityId::new("github.rerun_failed_workflow_run_jobs")?,
        CapabilityId::new("github.rerun_workflow_job")?,
