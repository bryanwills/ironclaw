...
is_shared_test_path() {
  ...
  case "$path" in
    ...
    scripts/ci/classify-test-scope.sh|scripts/ci/test-classify-test-scope.sh|scripts/ci/package-feature-flags.sh)
      return 0
      ;;
    .github/workflows/test.yml|.github/workflows/reborn-tests.yml|.github/workflows/reborn-integration.yml|.github/workflows/reborn-e2e.yml|.github/workflows/code_style.yml|.github/workflows/nightly-deep-ci.yml)
      return 0
      ;;
