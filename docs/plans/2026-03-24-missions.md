...
Already defined in `crates/agent/ironclaw_engine/src/types/mission.rs`.
...
`crates/agent/ironclaw_engine/src/runtime/mission.rs` — already has types, needs execution logic:
...
`crates/agent/ironclaw_engine/src/runtime/mission_prompt.rs`:
