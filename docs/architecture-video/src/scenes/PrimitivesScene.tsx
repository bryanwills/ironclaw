...
const PRIMITIVES = [
  {
    ...
    file: "crates/agent/ironclaw_engine/src/types/thread.rs",
  },
  {
    name: "Step",
    ...
    color: COLORS.cyan,
    file: "crates/agent/ironclaw_engine/src/types/step.rs",
  },
  {
    name: "Capability",
    ...
    color: COLORS.accent,
    file: "crates/agent/ironclaw_engine/src/capability/",
  },
  {
    name: "MemoryDoc",
    ...
    file: "crates/agent/ironclaw_engine/src/types/memory.rs",
  },
  {
    name: "Project",
    ...
    color: COLORS.purple,
    file: "crates/agent/ironclaw_engine/src/types/project.rs",
  },
];
...
export const PrimitivesScene: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        crates/agent/ironclaw_engine/ &mdash; replaces ~10 v1 abstractions
      </div>
